...
RenderPassHandler::RenderPassHandler(MainDevice* mainDevice, SwapChain* swaphcain){
...
VkAttachmentDescription RenderPassHandler::InputColourAttachment(const VkFormat& imageFormat){
    ...
    color_attachment_input.format = Utility::findSupportedFormat({VK_FORMAT_R32G32B32A32_SFLOAT},VK_IMAGE_TILING_OPTIMAL,
...
VkAttachmentDescription RenderPassHandler::InputPositionAttachment(const VkFormat& imageFormat){
    ...
    position_attachment_input.finalLayout = VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL;
...
VkAttachmentDescription RenderPassHandler::InputDepthAttachment(){
    ...
    depth_attachment_input.finalLayout = VK_IMAGE_LAYOUT_DEPTH_STENCIL_ATTACHMENT_OPTIMAL;
