...
namespace dg {
    ...
    void MaterialViewer::OnGUI() {
        ...
        if (!m_material) {
            ...
            ImGui::SameLine(dgUI::itemTab);
            ImGui::SliderFloat("##normal intensity", &m_material->uniformMaterial.intensity.x, 0.0f, 10.0f, "%0.5f", ImGuiSliderFlags_AlwaysClamp);
            ...
            ImGui::Text("metallic");
            ImGui::SameLine(dgUI::itemTab);
            ImGui::SliderFloat("##metallic", &m_material->uniformMaterial.mrFactor.x, 0.0f, 1.0f, "%0.5f", ImGuiSliderFlags_AlwaysClamp);
            ImGui::Text("roughness");
            ImGui::SameLine(dgUI::itemTab);
            ImGui::SliderFloat("##roughness", &m_material->uniformMaterial.mrFactor.y, 0.0f, 1.0f, "%0.5f", ImGuiSliderFlags_AlwaysClamp);
            ImGui::Text("ao intensity");
            ImGui::SameLine(dgUI::itemTab);
            ImGui::SliderFloat("##ao intensity", &m_material->uniformMaterial.mrFactor.z, 0.0f, 1.0f, "%0.5f", ImGuiSliderFlags_AlwaysClamp);
            ...
            ImGui::SameLine(dgUI::itemTab);
            ImGui::SliderFloat("##emis intensity", &m_material->uniformMaterial.intensity.y, 0.0f, 1.0f, "%0.5f", ImGuiSliderFlags_AlwaysClamp);

            ImGui::TextColored({217.0 / 255.0, 128.0 / 255.0, 250.0 / 255.0, 1.0f}, "Env Control");
            ImGui::Separator();
            ImGui::Text("env rotate");
            ImGui::SameLine(dgUI::itemTab);
            ImGui::SliderFloat("##env rotate", &m_material->uniformMaterial.envFactor.x, 0.0f, 10.0f, "%0.5f", ImGuiSliderFlags_AlwaysClamp);
            ImGui::Text("env exposure");
            ImGui::SameLine(dgUI::itemTab);
            ImGui::SliderFloat("##env exposure", &m_material->uniformMaterial.envFactor.y, 0.0f, 10.0f, "%0.5f", ImGuiSliderFlags_AlwaysClamp);
            ImGui::Text("env gamma");
            ImGui::SameLine(dgUI::itemTab);
            ImGui::SliderFloat("##env gamma", &m_material->uniformMaterial.envFactor.z, 0.0f, 5.0f, "%0.5f", ImGuiSliderFlags_AlwaysClamp);
